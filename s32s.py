...
TXT_MODE_INFO = "*** {mode} MODE *** S3 Routing Paths: '{mapspath}'"
TXT_EXECUTE_CMD = "EXECUTE: {cmd}"
TXT_ACTION_MASTER = "Upload local objects to S3 middleware"
TXT_ACTION_SLAVE = "Downoad objects from S3 middleware"
...
TXT_INPUT_INSERT_MAPS_PATH_EXIT = "Insert S3 path contains routing file/s for '{mode}' mode[x to Exit]"
TXT_INPUT_CONFIRM = "Enter 'y' to confirm, anything else to skip" 
TXT_WARNING_EXIT_TASK_WITH_ERROR = "Task not completed"
TXT_WARNING_MAPS_NOT_LOADED = "'{mode}' MAPS  not loaded, use 'mo' command to open routing file/s"
